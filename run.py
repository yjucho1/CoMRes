...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_experts', type=list, default=4)
    ...
    parser.add_argument('--unlabeled',type=int, default=1)
    parser.add_argument('--unlabel_type',type=str, default='interpolate', help='options:[interpolate, add_noise, time_warp]')
    ...
    parser.add_argument('--closs_epoch', type=int, default=20, help='consistency loss start epoch')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_ft{}_sl{}_pl{}_{}_{}_{}_{}'.format(
                args.model_id,
                args.model,
                args.data_path[:-4],
                args.features,
                args.seq_len,
                args.pred_len, args.random_seed, args.unlabeled, args.unlabel_type)
